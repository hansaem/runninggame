...
resources = "airport.png badak(off).png badak.png badak2.png boss.mp3 boss.png Brony+Story+-+Last+Mare.mp3 character.png font_cat.ttf game_over.png gong.png grass.png jump.png jump.wav jump_revers.png jump_revers2.png kpu_credit.png kuki.mp3 ohpaaca.png run.png run2.png run_animation.png run_boss.png shot.wav stom.png stop.png stop2.png stop2_revers.png story.mp3 strom.mp3 tanmak.png test.png test4.png test5.png title.png".split()
